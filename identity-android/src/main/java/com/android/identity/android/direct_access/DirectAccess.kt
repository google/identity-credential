...
object DirectAccess {
    ...
    /**
     * Initializes the transport so that the app can begin connecting to the applet in the background.
     */
    fun warmupTransport() {
     ...
     *
     * Note: this operation will not alter the state of the applet, ie. would not result in the
     * newly created credential being set as the active credential. In order to use the
     * created credential, [certifyCredential] and [setActiveCredential] must still be called.
     *
     ...
     *
     * Note: this operation will not alter the state of the applet, ie. would not result in the
     * newly certified credential being set as the active credential. In order to use the
     * certified credential, [setActiveCredential] must still be called.
     *
     ...
     *
     * @param documentSlot the slot
     * @return the number of times the credential in the slot was used since [clearCredentialUsageCount]
     *      was last called.
     * @throws Throwable if no active credential
     */
